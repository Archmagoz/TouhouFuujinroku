...
{
    // Owns fairy spawn timing, path assignment, and score-reporting wiring.
    ...
    public partial class FairySpawner : Node
    {
        ...
        // Also wires the fairy's IScoreable.Died event directly to Hud.ReportScore —
        ...
        private void SpawnFairy()
        {
            ...
            if (_hud != null && fairy is IScoreable scoreable)
